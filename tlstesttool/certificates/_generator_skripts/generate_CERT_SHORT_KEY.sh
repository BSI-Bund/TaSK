...
# use unsecure bitlength
MANIPULATION_ID="CERT_SHORT_KEY"
...
KEY_SIZE_RSA_DSA="1024" # this length is considered unsecure
LIFETIME_DAYS="1460"
...
declare -a EC_KEY_CURVES=("secp192r1") # this curve should not be supported
