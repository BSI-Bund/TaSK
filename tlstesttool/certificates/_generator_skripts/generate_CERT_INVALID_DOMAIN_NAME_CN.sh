...
# use manipulated configuration files 'SERVER_CONFIG' and 'CERTIFICATE_EXTENSION'
MANIPULATION_ID="CERT_INVALID_DOMAIN_NAME_CN"

# IN
HOME_DIR=$PWD
CERTIFICATE_EXTENSION="${HOME_DIR}/extension/test_certificate_INVALID_DOMAIN_NAME_CN.ext"
CA_CONFIG="${HOME_DIR}/configuration/test_ca_certificate.cnf"
SERVER_CONFIG="${HOME_DIR}/configuration/test_server_certificate_INVALID_DOMAIN_NAME_CN.cnf"
...
generateCertificateChain () {
    ...
    # use existing CA
    CA_KEY="../CERT_DEFAULT/test_ca_${PREFIX}_private_key.pem"
    CA_CERTIFICATE="../CERT_DEFAULT/test_ca_${PREFIX}_certificate.pem"
