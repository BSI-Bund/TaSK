...
# use manipulated configuration file 'CERTIFICATE_EXTENSION'
MANIPULATION_ID="CERT_INVALID_DOMAIN_NAME_SAN"

# IN
HOME_DIR=$PWD
CERTIFICATE_EXTENSION="${HOME_DIR}/extension/test_certificate_INVALID_DOMAIN_NAME_SAN.ext"
