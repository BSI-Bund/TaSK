...
# use an unsupported hash algorithm for a DEFAULT RSA cert
MANIPULATION_ID="CERT_DEFAULT_UNSUPPORTED"
...
declare -a SIGNATURE_ALGORITHM=(sha1)
declare -a KEY_ALGORITHM=("RSA" "RSA-PSS") 
