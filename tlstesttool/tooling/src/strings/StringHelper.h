 ...
 */
        template<typename T>
        inline std::string formatInt(const std::string &formatString, const T number) {
 ...
 */
        inline std::string
        replaceAll(const std::string &input, const std::string &search, const std::string &replacement) {
