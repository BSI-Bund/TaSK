...
*/
#ifndef TLS_OPENSSL_TLSSESSION_H_
#define TLS_OPENSSL_TLSSESSION_H_
...
namespace TlsTestTool {
    namespace OpenSsl {
/**
 * Implementation of TlsSession using OpenSSL.
 *
 */
        class TlsSession : public TlsTestTool::TlsSession {
        public:

            /* Structure for CertificateStatusCallback */
            typedef struct tlsStatusExtensionContext {
                /* OCSP Response file to load */
                char *ocspResponseFile;
            } tlsStatusExtensionContext;
             ...
             */
            virtual void setCaCertificate(std::string caCertificatePath) override;
            ...
            /**
             * Convert TestTool Version Format to OpenSSL format
             * @param version
             * @return
             */
            uint32_t getOpenSSLVersionFormat(const TlsVersion &version);
             ...
             */
            virtual void
            setEllipticCurveGroups(const std::vector<TlsEllipticCurveGroupID> &ellipticCurveGroups) override;
             ...
             */
            void setSignatureAlgorithms(const std::vector<TlsSignatureAndHashAlgorithm> &signatureAlgorithms) override;
            ...
            * @param enable If @c true, it will be advertised in a Hello message. If @c false, it will not be used.
            */
            virtual void setExtensionExtendedMasterSecret(const bool enable) override;
            ...
            /**
             * Overwrite the field EncryptedExtensions.extensions with a given value.
             * @param List of bytes that will be sent in EncryptedExtensions.extensions
             */
            virtual void setEncryptedExtensionsTls13(const std::vector<uint8_t> &encryptedExtensions) override;
            ...
            */
            virtual void setPreSharedKey(const std::vector<uint8_t> &preSharedKey, const std::string pskIdentity,
                                         const std::string pskIdentityHint) override;
            ...
            /**
             * Configures the Context of OpenSSL
             */
            void configureOpensslContext();

            /**
             * Get the configured PreSharedKey of current session
             */
        ...
        private:
            ...
            /**
             * Hook that is called before sending a TLS handshake message.
             * @param isSent @c true if the message is outgoing, @c false if the message is incoming.
             * @return 0 if successful, non zero to stop the handshake.
             */
            int preHandshakeStep(const bool isSent);

            /**
             * Hook that is called after sending a TLS handshake message.
             * @param isSent @c true if the message is outgoing, @c false if the message is incoming.
             * @return 0 if successful, non zero to stop the handshake.
             */
            int postHandshakeStep(const bool isSent);
...
#endif /* TLS_OPENSSL_TLSSESSION_H_ */
