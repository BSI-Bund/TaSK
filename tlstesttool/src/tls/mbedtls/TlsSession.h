 ...
 */
        ...
        public:
             ...
             */
            virtual void setCaCertificate(std::string caCertificate) override;
            ...
            /**
                 ...
                 */
            virtual void
            setSignatureAlgorithms(const std::vector<TlsSignatureAndHashAlgorithm> &signatureAlgorithms) override;
