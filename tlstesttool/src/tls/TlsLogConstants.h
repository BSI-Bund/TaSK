 ...
 */
    namespace TlsLogConstants {
        ...
        const char *const CLIENT_CERTIFICATE_RX_VALID = "Valid Certificate message received.\n";
        const char *const CLIENT_CERTIFICATE_RX_BAD = "Bad Certificate message received.\n";
        const char *const CLIENT_CERTIFICATE_TX = "Certificate message transmitted.\n";
