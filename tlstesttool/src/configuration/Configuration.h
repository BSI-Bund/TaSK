 ...
 */
    ...
    public:
        ...
        Configuration()
                : mode(NetworkMode::UNKNOWN),
                  ...
                  pskIdentityHint(),
                  ocspResponseFile(""),
                  startTlsProtocol(StartTLSProtocol::NONE) {
        }
        ...
        const std::vector<uint8_t> &getServerHelloExtension() const {
            return serverHelloExtension;
        }

        void setServerHelloExtension(const std::vector<uint8_t> &serverHelloExtension) {
            Configuration::serverHelloExtension = serverHelloExtension;
        }

        const std::vector<uint8_t> &getEncryptedExtensionsTls13() const {
            return encryptedExtensionsTls13;
        }

        void setEncryptedExtensionsTls13(const std::vector<uint8_t> &encryptedExtensionsTls13) {
            Configuration::encryptedExtensionsTls13 = encryptedExtensionsTls13;
        }
        ...
        bool isTlsExtendedMasterSecret() const {
            return tlsExtendedMasterSecret;
        }

        void setTlsExtendedMasterSecret(bool tlsExtendedMasterSecret) {
            Configuration::tlsExtendedMasterSecret = tlsExtendedMasterSecret;
        }

        StartTLSProtocol getStartTlsProtocol() const {
            return startTlsProtocol;
        }

        void setStartTlsProtocol(StartTLSProtocol startTlsProtocol) {
    ...
    private:
        ...
        std::vector<uint8_t> serverHelloExtension; //only for OpenSSL
        std::vector<uint8_t> encryptedExtensionsTls13; //only for OpenSSL
        int sessionLifetime;
        std::vector<uint8_t> preSharedKey;
        std::string pskIdentity;
        std::string pskIdentityHint;
        std::string ocspResponseFile;
        bool tlsExtendedMasterSecret;
