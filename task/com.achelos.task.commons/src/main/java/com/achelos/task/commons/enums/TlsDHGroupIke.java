...
/**
 * groups for Internet Key Exchange (IKE) * @see <a href="https://tools.ietf.org/html/rfc3526">RFC 3526.</a>
 */
public enum TlsDHGroupIke {

	/**
	 * 1536-bit MODP Group.
	 */
	group5(5, "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD1" + "29024E088A67CC74020BBEA63B139B22514A08798E3404DD"
			...
			+ "83655D23DCA3AD961C62F356208552BB9ED529077096966D" + "670C354E4ABC9804F1746C08CA237327FFFFFFFFFFFFFFFF",
			"02"),
	/**
	 * 2048-bit MODP Group.
	 */
	group14(14, "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD1" + "29024E088A67CC74020BBEA63B139B22514A08798E3404DD"
			+ "EF9519B3CD3A431B302B0A6DF25F14374FE1356D6D51C245" + "E485B576625E7EC6F44C42E9A637ED6B0BFF5CB6F406B7ED"
			+ "EE386BFB5A899FA5AE9F24117C4B1FE649286651ECE45B3D" + "C2007CB8A163BF0598DA48361C55D39A69163FA8FD24CF5F"
			...
			+ "15728E5A8AACAA68FFFFFFFFFFFFFFFF", "02"),
	/**
	 * 3072-bit MODP Group.
	 */
	group15(15, "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD1" + "29024E088A67CC74020BBEA63B139B22514A08798E3404DD"
			+ "EF9519B3CD3A431B302B0A6DF25F14374FE1356D6D51C245" + "E485B576625E7EC6F44C42E9A637ED6B0BFF5CB6F406B7ED"
			+ "EE386BFB5A899FA5AE9F24117C4B1FE649286651ECE45B3D" + "C2007CB8A163BF0598DA48361C55D39A69163FA8FD24CF5F"
			+ "83655D23DCA3AD961C62F356208552BB9ED529077096966D" + "670C354E4ABC9804F1746C08CA18217C32905E462E36CE3B"
			+ "E39E772C180E86039B2783A2EC07A28FB5C55DF06F4C52C9" + "DE2BCBF6955817183995497CEA956AE515D2261898FA0510"
	 ...
	 * 4096-bit MODP Group.
	 */
	group16(16, "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD1" + "29024E088A67CC74020BBEA63B139B22514A08798E3404DD"
			+ "EF9519B3CD3A431B302B0A6DF25F14374FE1356D6D51C245" + "E485B576625E7EC6F44C42E9A637ED6B0BFF5CB6F406B7ED"
			+ "EE386BFB5A899FA5AE9F24117C4B1FE649286651ECE45B3D" + "C2007CB8A163BF0598DA48361C55D39A69163FA8FD24CF5F"
			+ "83655D23DCA3AD961C62F356208552BB9ED529077096966D" + "670C354E4ABC9804F1746C08CA18217C32905E462E36CE3B"
			+ "E39E772C180E86039B2783A2EC07A28FB5C55DF06F4C52C9" + "DE2BCBF6955817183995497CEA956AE515D2261898FA0510"
			...
			+ "93B4EA988D8FDDC186FFB7DC90A6C08F4DF435C934063199" + "FFFFFFFFFFFFFFFF", "02"),
	/**
	 * 6144-bit MODP Group.
	 */
	group17(17,
	 ...
	 * 8192-bit MODP Group.
	 */
	group18(18, "FFFFFFFFFFFFFFFFC90FDAA22168C234C4C6628B80DC1CD1" + "29024E088A67CC74020BBEA63B139B22514A08798E3404DD"
			+ "EF9519B3CD3A431B302B0A6DF25F14374FE1356D6D51C245" + "E485B576625E7EC6F44C42E9A637ED6B0BFF5CB6F406B7ED"
			+ "EE386BFB5A899FA5AE9F24117C4B1FE649286651ECE45B3D" + "C2007CB8A163BF0598DA48361C55D39A69163FA8FD24CF5F"
			+ "83655D23DCA3AD961C62F356208552BB9ED529077096966D" + "670C354E4ABC9804F1746C08CA18217C32905E462E36CE3B"
			+ "E39E772C180E86039B2783A2EC07A28FB5C55DF06F4C52C9" + "DE2BCBF6955817183995497CEA956AE515D2261898FA0510"
	 ...
	 * @param prime the prime value as hex string
	 * @param generator the group generator
	 */
	TlsDHGroupIke(final int id, final String prime, final String generator) {
		this.id = id;
		this.prime = prime;
	...
	/**
	 * Get the named group's prime.
	 *
	 * @return Prime as hex string
	 */
	...
	/**
	 * Get the named group's generator.
	 *
	...
	public String toString() {
		return String.format("%s(%s, x%02x)", name(), prime, generator);
	}


	/**
	 * Get the value associated with the given group id.
	 *
	 * @param id the group id
	 * @return group
	 */
	public static TlsDHGroupIke valueOf(final int id) {
		for (TlsDHGroupIke group : TlsDHGroupIke.values()) {
			if (group.id == id) {
				return group;
			}
		}
	...
	/**
	 * Get the value associated with the given prime and generator.
	 *
	 * @param prime the prime
	 * @param generator the generator
	 * @return group
	 */
	public static TlsDHGroupIke valueOf(final String prime, final String generator) {
		for (TlsDHGroupIke group : TlsDHGroupIke.values()) {
			if (group.prime.equalsIgnoreCase(prime) && group.generator.equalsIgnoreCase(generator)) {
				return group;
			}
		}
		return null;
