...
/**
 * Test case TLS_B2_GP_08 - Unsupported signature algorithm.
 * <p>
 ...
 */
public class TLS_B2_GP_08 extends AbstractTestCase {

	private static final String TEST_CASE_ID = "TLS_B2_GP_08";
	...
	protected final void executeUsecase() throws Exception {
		...
		if (null != unsupportedSignatureAlgorithm.getSignatureAlgorithm()
			...
			logger.debug("Not Supported Signature Algorithms: "
					...
					+ "With" + unsupportedSignatureAlgorithm.getHashAlgorithm().getHashAlgorithmDescription());
		}
