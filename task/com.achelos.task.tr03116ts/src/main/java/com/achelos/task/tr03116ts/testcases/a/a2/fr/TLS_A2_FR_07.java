...
/**
 * Test case TLS_A2_FR_07 - Truncated-HMAC extension.
 * <p>
 * This test verifies that the Truncated-HMAC extension is not offered and cannot be used in a connection.
 */
public class TLS_A2_FR_07 extends AbstractTestCase {

	private static final String TEST_CASE_ID = "TLS_A2_FR_07";
	...
	protected final void executeUsecase() throws Exception {
		...
		tfServerHello.executeSteps("3", "Server started and waits for new client connection", Arrays.asList(), testTool,
				tlsVersion, cipherSuite, new TlsExtTruncatedHmac(), new RequestClientCertificate());
