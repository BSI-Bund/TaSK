...
/**
 * Test case TLS_A2_CH_07 - Server certificate with wrong host name.
 * 
 * <p>
 * The test case verifies the correct behaviour of the DUT in case the server sends a certificate that does not match
 * the domain the DUT wanted to connect to. The common name of the host certificate does not match with the server's
 * host name.
 * 
 */
public class TLS_A2_CH_07 extends AbstractTestCase {

	private static final String TEST_CASE_ID = "TLS_A2_CH_07";
	private static final String TEST_CASE_DESCRIPTION = "Server certificate with wrong host name";
	private static final String TEST_CASE_PURPOSE
			= "The test case verifies the correct behaviour of the DUT in case the server sends a certificate that "
					+ "does not match the domain the DUT wanted to connect to. The common name of the host certificate "
					+ "does not match with the server's host name.";
	 ...
	 * <h3>Description</h3>
	 * <ol>
	 * <li>The server supplies the certificate chain [CERT_INVALID_DOMAIN_NAME_CN].
	 * <li>The server sends a CertificateRequest to the DUT.
	 * </ol>
	 *
	 * <h3>ExpectedResult</h3>
	 * <ul>
	 * <li>The DUT does not accept the certificate chain and sends a ""certificate_unknown"" alert or another suitable error description.
	...
	protected final void executeUsecase() throws Exception {
		...
		tfServerHello.executeSteps("3",
				...
				Arrays.asList(), testTool, tlsVersion, cipherSuite, new RequestClientCertificate());
