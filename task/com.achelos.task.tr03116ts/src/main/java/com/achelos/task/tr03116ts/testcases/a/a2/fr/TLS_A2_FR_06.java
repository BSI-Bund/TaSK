...
/**
 * Test case TLS_A2_FR_06 - Encrypt-then-MAC extension.
 * <p>
 * This test verifies that the Encrypt-then-MAC Extension is offered and can be used in a connection with a CBC-mode
 * cipher suite
 */
public class TLS_A2_FR_06 extends AbstractTestCase {

	private static final String TEST_CASE_ID = "TLS_A2_FR_06";
	...
	protected final void executeUsecase() throws Exception {
		...
		tfServerHello.executeSteps("3", "Server started and waits for new client connection", Arrays.asList(), testTool,
				tlsVersion, cipherSuites, new TlsExtEncryptThenMac(), new RequestClientCertificate());
