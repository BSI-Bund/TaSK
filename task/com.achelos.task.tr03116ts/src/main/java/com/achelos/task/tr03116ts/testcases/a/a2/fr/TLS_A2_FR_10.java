...
/**
 * Test case TLS_A2_FR_10 - Session resumption with session ID.
 * <p>
 * Positive test verifying the session resumption through the Session ID.
 */
public class TLS_A2_FR_10 extends AbstractTestCase {

	private static final String TEST_CASE_ID = "TLS_A2_FR_10";
	...
	protected final void executeUsecase() throws Exception {
		...
		tFDutClientNewConnection.executeSteps("11",
		...
		step(12, "Check if the TLS ClientHello initiates session resumption via Session ID extension with the correct "
				+ "value.",
		...
		step(13, "Check if the session resumption is executed without errors and the channel is established.",
		...
		tfApplicationCheck.executeSteps("14", "", Arrays.asList(), testTool, dutExecutor);
