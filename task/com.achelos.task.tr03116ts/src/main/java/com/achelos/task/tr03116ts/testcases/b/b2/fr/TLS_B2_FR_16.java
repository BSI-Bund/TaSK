...
import com.achelos.task.commons.tlsextensions.TlsExtPskExchangeModesTls13;
...
/**
 * Test case TLS_B2_FR_16 - Reconnect via Session Ticket
 * <p>
 ...
 */
public class TLS_B2_FR_16 extends AbstractTestCase {

	private static final String TEST_CASE_ID = "TLS_B2_FR_16";
	...
	protected final void executeUsecase() throws Exception {
		...
		step(6, "The tester closes the connection to the DUT and stores the Session Ticket.", "");
		logger.info("Initial handshake was successfully executed and the session ticket was stored");

		/* Step 7: Reconnect with Session ticket */
		...
		tfClientHello.executeSteps("8", "The TLS ClientHello offers the TLS version " + tlsVersion.getName()
