...
/**
 * Test case TLS_B2_FR_17 - No 0-RTT connection.
 * <p>
 * This test case checks that the early data is not used by the DUT.
 */
public class TLS_B2_FR_17 extends AbstractTestCase {

	private static final String TEST_CASE_ID = "TLS_B2_FR_17";
	 ...
	 * <h3>Command</h3>
	 * <ol>
	 * <li>Less than the maximum allowed amount of time later, the tester reconnects to the DUT and performs 0-RTT connection establishment with early data.
	 * </ol>
	 *
	 * <h3>ExpectedResult</h3>
	 * <ul>
	...
	protected final void executeUsecase() throws Exception {
		...
		step(6, "\tThe tester closes the connection to the DUT and stores the Session\n" +
				"\t * Ticket.", "");
		logger.info("Initial handshake was successfully executed and the session ticket was stored");

		/* Step 7: Perform a 0-RTT connection */
		step(7, "Less than the maximum allowed amount of time later, the tester reconnects "
		...
		tfClientCertificate.executeSteps("8",
				"The TLS client supplies the valid certificate chain [CERT_DEFAULT_CLIENT].", Arrays.asList(),
				testTool, tlsVersion, TlsTestToolCertificateTypes.CERT_DEFAULT_CLIENT);

		tfClientHello.executeSteps("9", "The TLS ClientHello offers the TLS version " + tlsVersion.getName()
