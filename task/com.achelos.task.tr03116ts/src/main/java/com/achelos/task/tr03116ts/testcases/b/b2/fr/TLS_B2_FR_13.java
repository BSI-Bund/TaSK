 ...
 * of time.
 */
public class TLS_B2_FR_13 extends AbstractTestCase {
	
	private static final String TEST_CASE_ID = "TLS_B2_FR_13";
	...
	protected final void executeUsecase() throws Exception {
		...
		step(6, "The client tries to keep the connection running for more than the maximum"
		...
		tFTCPIPCloseConnection.executeSteps("7", "The TLS connection is closed by the server.", Collections.emptyList(),
				testTool);
	}
