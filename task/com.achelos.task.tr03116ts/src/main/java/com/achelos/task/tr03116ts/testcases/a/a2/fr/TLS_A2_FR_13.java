...
/**
 * Test case TLS_A2_FR_13 - Random value for gmt_unix_time.
 * <p>
 * Positive test verifying the value for gmt_unix_time in ClientHello to be random.
 */
public class TLS_A2_FR_13 extends AbstractTestCase {

	private static final String TEST_CASE_ID = "TLS_A2_FR_13";
	...
	protected final void executeUsecase() throws Exception {
		...
		tfServerHello.executeSteps("3", "Server started and waits for new client connection", Arrays.asList(), testTool,
				tlsVersion, cipherSuite, new RequestClientCertificate());
		...
		fFTLSHighestVersionSupportCheck.executeSteps("5",
				"The TLS ClientHello offers the TLS version [TLS_VERSION].", null,
				testTool);
		...
		step(8, "Check if the client supplies a valid client certificate and a correct CertificateVerify message.",
		...
		step(9, "Check if the TLS protocol is executed without errors and the channel is established.",
