...
/**
 * Test case TLS_A2_GP_02_T - Signature_algorithms match the ICS.
 * 
 * <p>
 ...
 * 
 */
public class TLS_A2_GP_02_T extends AbstractTestCase {

	private static final String TEST_CASE_ID = "TLS_A2_GP_02_T";
		...
		for (TlsVersion tlsVersion : tlsVersions) {
			...
			for (TlsSignatureAlgorithmWithHash sigAlg : sigAlgorithms) {
				...
				tftlsServerHello.executeSteps("3", "Server started and waits for new client connection",
						Arrays.asList(),
						testTool, tlsVersion, new RequestClientCertificate());
