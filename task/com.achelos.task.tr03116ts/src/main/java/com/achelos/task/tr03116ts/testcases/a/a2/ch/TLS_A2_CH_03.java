...
/**
 * Test case TLS_A2_CH_03 - Host certificate with wrong domain name.
 *  
 * <p>
 ...
 */
public class TLS_A2_CH_03 extends AbstractTestCase {

	private static final String TEST_CASE_ID = "TLS_A2_CH_03";
	 ...
	 * <h3>Description</h3>
	 * <ol>
	 * <li>The server supplies the certificate chain [CERT_INVALID_DOMAIN_NAME_SAN].
	...
	protected final void executeUsecase() throws Exception {
		...
		tfserverCertificate.executeSteps("2", "The server supplies the certificate chain [CERT_INVALID_DOMAIN_NAME].",
				...
				TlsTestToolCertificateTypes.CERT_INVALID_DOMAIN_NAME_SAN);
