...
/**
 * Test case TLS_B2_FR_09 - Session renegotiation.
 * <p>
 * This test verifies the correct behaviour of the DUT in case the client tries to renegotiate the parameters.
 */
public class TLS_B2_FR_09 extends AbstractTestCase {

	private static final String TEST_CASE_ID = "TLS_B2_FR_09";
	 ...
	 * <h3>ExpectedResult</h3>
	 * <ul>
	 * <li>The DUT either ignores the request or answers with a ""no_renegotiation"" alert or another suitable alert description.
	 * </ul>
	 */
	@Override
	protected final void executeUsecase() throws Exception {
		...
		tfAlertMessageCheck.executeSteps("5",
				"The DUT either ignores the request or answers with a \"no_renegotiation\" alert or another suitable "
						+ "alert\" description.",
				Arrays.asList("level=warning/fatal", "description=no_renegotiation"), testTool, TlsAlertDescription.no_renegotiation);
