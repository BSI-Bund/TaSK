...
/**
 * Test case TLS_A2_FR_08 - Disconnect after maximum time.
 * <p>
 * This test verify that an active connection is disconnected by the client after being active for the maximum allowed
 * amount of time.
 */
public class TLS_A2_FR_08 extends AbstractTestCase {

	private static final String TEST_CASE_ID = "TLS_A2_FR_08";
	...
	protected final void executeUsecase() throws Exception {
		...
		step(8, "Check if the TLS connection is closed by the client.", "The TLS connection is closed by the client.");
