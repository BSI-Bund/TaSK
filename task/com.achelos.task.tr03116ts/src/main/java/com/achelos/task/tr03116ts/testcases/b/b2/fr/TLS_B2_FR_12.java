...
/**
 * Test case TLS_B2_FR_12 - Compression not selected.
 * <p>
 * This test case checks that compression is not selected by the DUT.
 */
public class TLS_B2_FR_12 extends AbstractTestCase {

	private static final String TEST_CASE_ID = "TLS_B2_FR_12";
	...
	protected final void executeUsecase() throws Exception {
		...
		step(4, "Check if the DUT did not select the DEFLATE compression.",
