...
/**
 * Test case TLS_A2_CH_09 - Server certificate revoked by CRL.
 * 
 * <p>
 * This test verifies the behaviour of the DUT when retrieving a CRL revealing that the server certificate is revoked.
 * 
 */
public class TLS_A2_CH_09 extends AbstractTestCase {

	private static final String TEST_CASE_ID = "TLS_A2_CH_09";
	 ...
	 * <li>The DUT aborts the connection and sends a ""bad_certificate_status_response"" alert or another suitable error description.
