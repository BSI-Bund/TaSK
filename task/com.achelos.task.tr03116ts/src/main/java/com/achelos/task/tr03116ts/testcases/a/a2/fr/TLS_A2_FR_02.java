...
/**
 * Test case TLS_A2_FR_02 - Heartbeat extension.
 * <p>
 * This test verifies the behaviour of the DUT if the server sends a heartbeat extension.
 */
public class TLS_A2_FR_02 extends AbstractTestCase {

	private static final String TEST_CASE_ID = "TLS_A2_FR_02";
	...
	protected final void executeUsecase() throws Exception {
		...
		tfServerHello.executeSteps("3",
				...
				Arrays.asList(), testTool, tlsVersion, cipherSuite, heartbeatExtension, new RequestClientCertificate());
