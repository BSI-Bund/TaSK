...
/**
 * Test case TLS_A2_FR_03 - Heartbeat request.
 * <p>
 * This test verifies the behaviour of the DUT if the server sends a heartbeat request.
 */
public class TLS_A2_FR_03 extends AbstractTestCase {

	private static final String TEST_CASE_ID = "TLS_A2_FR_03";
	...
	protected final void executeUsecase() throws Exception {
		...
		step(5, "Check if the client supplies a valid client certificate and a correct CertificateVerify message.",
		...
		step(7, "The TLS server sends a \"heartbeat_request\".", "The DUT ignores the request.");

		tfAlertMessageCheck.executeSteps("8", "",
