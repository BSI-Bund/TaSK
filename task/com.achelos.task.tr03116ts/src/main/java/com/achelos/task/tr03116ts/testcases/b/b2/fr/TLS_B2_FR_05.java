...
/**
 * Test case TLS_B2_FR_05 - Reconnect after maximum time.
 * <p>
 * This tests verifies that it is not possible to re-establish a TLS connection that is older than the maximum allowed
 * amount of time.
 */
public class TLS_B2_FR_05 extends AbstractTestCase {

	private static final String TEST_CASE_ID = "TLS_B2_FR_05";
	 ...
	 * <h3>Command</h3>
	 * <ol>
	 * <li>More than the maximum allowed amount of time later, the tester reconnects to the DUT using the old Session ID.
	 * </ol>
	 *
	 * <h3>Description</h3>
	 * <ol>
	...
	protected final void executeUsecase() throws Exception {
		...
		step(8, "Receive ServerHello from TOE with session_id != $SessionID (Session resumption is refused by"
				+ " TOE).", "");
