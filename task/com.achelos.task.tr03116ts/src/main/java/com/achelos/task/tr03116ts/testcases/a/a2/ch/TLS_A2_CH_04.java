...
/**
 * Test case TLS_A2_CH_04 - Corrupt server certificate.
 * 
 * <p>
 * The test case verifies the correct behaviour of the DUT in case the server sends a corrupt certificate.
 * 
 */
public class TLS_A2_CH_04 extends AbstractTestCase {

	private static final String TEST_CASE_ID = "TLS_A2_CH_04";
	private static final String TEST_CASE_DESCRIPTION = "Corrupt server certificate";
	 ...
	 * <h3>Description</h3>
	 * <ol>
	 * <li>The server supplies the certificate chain [CERT_INVALID_STRUCTURE].
	 * <li>The server sends a CertificateRequest to the DUT.
	 * </ol>
	 *
	 * <h3>ExpectedResult</h3>
	 * <ul>
	 * <li>The DUT does not accept the certificate chain and sends a ""bad_certificate"" alert or another suitable error description.
	...
	protected final void executeUsecase() throws Exception {
		...
		tfserverCertificate.executeSteps("2", "The server supplies the certificate chain [CERT_INVALID_STRUCTURE].",
				Arrays.asList(), testTool, tlsVersion, cipherSuite, TlsTestToolCertificateTypes.CERT_INVALID_STRUCTURE);
