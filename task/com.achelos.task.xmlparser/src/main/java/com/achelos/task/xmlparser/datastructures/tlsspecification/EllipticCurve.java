...
/**
 * Internal data structure representing an Elliptic Curve in an Application Specification.
 */
public class EllipticCurve extends SpecDetails {

	/**
	 * Constructor setting all information regarding this Elliptic Curve.
	 ...
	 */
	public EllipticCurve(final RestrictionLevel restriction, final String description, final String identifierValue,
