...
/**
 * Internal data structure representing a SignatureAlgorithm in an Application Specification.
 */
public class SignatureAlgorithm extends SpecDetails {

	/**
	 * Constructor setting all information regarding this SignatureAlgorithm.
	 ...
	 */
	public SignatureAlgorithm(final RestrictionLevel restriction, final String description,
			final String identifierValue,
			final String reference, final String useUntil, final int priority) {
