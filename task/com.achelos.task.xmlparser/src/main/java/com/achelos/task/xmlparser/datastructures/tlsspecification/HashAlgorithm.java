...
/**
 * Internal data structure representing a HashAlgorithm in an Application Specification.
 */
public class HashAlgorithm extends SpecDetails {

	/**
	 * Constructor setting all information regarding this HashAlgorithm.
	 ...
	 */
	public HashAlgorithm(final RestrictionLevel restriction, final String description, final String identifierValue,
